...
class ApiService {
  ...
  async createPickup(
    ...
    try {
      return await this.api.post("/pickups", formData, {
        ...
        timeout: 120000, // 30 seconds for image upload and AI processing
      });
    } catch (error: any) {
      // eslint-disable-next-line no-console
  ...
  // Dashboard Stats
  async getAdminDashboardStats(): Promise<AxiosResponse<ApiResponse<any>>> {
    return this.api.get("/admin/dashboard/stats");
  }

  async getSystemHealth(): Promise<AxiosResponse<ApiResponse<any>>> {
    return this.api.get("/admin/dashboard/system-health");
  }
  ...
  async getUserById(id: string): Promise<AxiosResponse<ApiResponse<any>>> {
  ...
  async updateUser(id: string, userData: {
    ...
    return this.api.put(`/admin/users/${id}`, userData);
  }

  async deleteUser(id: string): Promise<AxiosResponse<ApiResponse<any>>> {
    return this.api.delete(`/admin/users/${id}`);
  }

  async verifyUserEmail(id: string): Promise<AxiosResponse<ApiResponse<any>>> {
    return this.api.put(`/admin/users/${id}/verify-email`);
  }

  async changeUserRole(id: string, role: string): Promise<AxiosResponse<ApiResponse<any>>> {
    return this.api.put(`/admin/users/${id}/change-role`, { role });
  }

  // Pickup Management
  async getPickupsOverview(params?: {
    startDate?: string;
    endDate?: string;
  }): Promise<AxiosResponse<ApiResponse<any>>> {
    return this.api.get("/admin/pickups/overview", { params });
  }

  async getContaminationReport(params?: {
    startDate?: string;
    endDate?: string;
  }): Promise<AxiosResponse<ApiResponse<any>>> {
    return this.api.get("/admin/pickups/contamination-report", { params });
  }

  // Analytics
  async getUserActivityAnalytics(period = "30d"): Promise<AxiosResponse<ApiResponse<any>>> {
    return this.api.get("/admin/analytics/user-activity", { params: { period } });
  }

  async getWasteTrends(period = "30d"): Promise<AxiosResponse<ApiResponse<any>>> {
    return this.api.get("/admin/analytics/waste-trends", { params: { period } });
  }
  ...
  async runSystemCleanup(): Promise<AxiosResponse<ApiResponse<any>>> {
    return this.api.post("/admin/system/cleanup");
  }
  ...
  async sendBroadcastNotification(data: {
    ...
    return this.api.post("/admin/notifications/broadcast", data);
  }
}
