...
import { type User, type LoginRequest, type RegisterRequest, type ForgotPasswordRequest, type ResetPasswordRequest } from "../types";
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const forgotPassword = async (data: ForgotPasswordRequest) => {
    try {
      ...
      // For security reasons, we still show success message even on error
      toast.success('Password reset instructions sent to your email!');
    }
  };
